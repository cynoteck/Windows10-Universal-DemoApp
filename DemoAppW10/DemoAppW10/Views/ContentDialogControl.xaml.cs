...
namespace DemoAppW10.Views
{
    ...
    /// </summary>
    public sealed partial class ContentDialogControl : Page
    {
        public ContentDialogControl()
        {
            this.InitializeComponent();
            this.Loaded += ContentDialogControl_Loaded;
         
        }

        private async void ContentDialogControl_Loaded(object sender, RoutedEventArgs e)
        {
